  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => setIsModalOpen(true)}
          className="fixed bottom-6 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white shadow-lg shadow-violet-500/30 transition-all hover:from-violet-700 hover:to-fuchsia-700 hover:shadow-violet-500/40 active:scale-95 md:hidden"
        >
