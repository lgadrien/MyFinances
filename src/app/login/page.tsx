          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-slate-800 py-2.5 pl-4 pr-10 text-sm outline-none transition-all focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 placeholder:text-slate-600"
                placeholder="••••••••"
                required
                autoFocus
              />
