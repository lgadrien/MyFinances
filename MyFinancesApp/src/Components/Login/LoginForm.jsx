...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Rediriger vers la page '/my-account' puis forcer le rechargement
      navigate('/my-account');  // Redirection vers la page '/my-account'

      setTimeout(() => {
        window.location.reload();  // Recharger la page après la redirection
      }, 100);  // Petit délai pour permettre la redirection avant le rechargement
